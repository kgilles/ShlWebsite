    ...
    <div class="posts2">
        ...
        <div id="two">
            ...
            <table border="0" cellspacing="{$theme['borderwidth']}" cellpadding="{$theme['tablespace']}" class="tborder">
                ...
                <tr>
                    <td class="trow1">
                        ...
                        <div class="float_right">
                            <?php
                        // Gets user from DB.
                            $userquery = $db->simple_select("users", "bankbalance, teamid", "uid=$uid", array("limit" => 1));
                            $curruser = $db->fetch_array($userquery);
                            $bankbalance = intval($curruser["bankbalance"]);
                            $teamid = intval($curruser["teamid"]);

                            $userquery = $db->simple_select("teams", "*", "id=$teamid", array("limit" => 1));
                            $teamrow = $db->fetch_array($userquery);
                ...
                <tr>
                    <td class="trow1">
                        <div class="float_left"><strong>SHL Team:</strong></div>
                        <div class="float_right">
                            <?php
                            echo $teamname;
                            ?>
...
<style>
    .us {
        overflow: hidden;
        text-align: center: float: center: margin: auto auto;
    }
